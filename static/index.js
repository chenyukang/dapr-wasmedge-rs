  ...
  [6], {
        ...
        return Object(r.jsxs)("div", {
          ...
          children: [Object(r.jsxs)(i.a, {
            ...
            children: [Object(r.jsxs)("h1", {
              className: u.a.title,
              children: ["Welcome to ", Object(r.jsx)("a", {
                href: "https://github.com/WasmEdge/WasmEdge",
                children: "WasmEdge!"
              })]
            }), Object(r.jsxs)("div", {
              className: u.a.operating,
              children: [Object(r.jsxs)("div", {
                children: [Object(r.jsx)("input", {
                  type: "file",
                  id: "fileElem",
                  accept: "image/jpeg",
                  className: u.a["visually-hidden"],
                  onChange: function(e) {
                    var t = e.target.files[0];
                    if (!t) return;
                    if (!t.type.startsWith("image/jpeg")) return void alert("Please select a jpeg image.");
                    var r = document.createElement("img");
                    r.file = t;
                    var o = new FileReader;
                    o.onload = (a = r, function(e) {
                      a.src = e.target.result, s(a), n(!0), p("")
                    }), o.readAsDataURL(t);
                    var a
                  }
                }), Object(r.jsx)("label", {
                  htmlFor: "fileElem",
                  className: u.a.noselect,
                  ...
                  onClick: function(e) {
                    ...
                    t.onload = function(e) {
                      ...
                      t.open("POST", "/api/hello", !0), t.onload = function() {
                        h(!1), p(t.response)
                      };
                      var n = new Blob([e.target.result], {
                        type: "application/octet-stream"
                      });
                      t.send(n)
                    }, t.readAsArrayBuffer(c.file)
                  },
                  disabled: !t || m,
                  children: m ? "Loading" : "Classify with Wasm"
                })]
              }), Object(r.jsx)("div", {
                className: u.a.infer,
            ...
            children: Object(r.jsxs)("a", {
              ...
              children: ["Powered by", " ", Object(r.jsx)("img", {
                src: "/vercel.svg",
                alt: "Vercel Logo",
                className: u.a.logo
              })]
    ...
    vRNQ: function(e, t, n) {
      e.exports = {
        ...
        "visually-hidden": "Home_visually-hidden__2f7en",
        operating: "Home_operating__2UI4g",
        noselect: "Home_noselect__1AQeP",
        thumb: "Home_thumb__2D654",
        infer: "Home_infer__3mXpF"
      }
    },
    vlRD: function(e, t, n) {
